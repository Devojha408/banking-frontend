        ...
        <Fragment>
            ...
            <Form onSubmit={handleForm}>
                <FormGroup row>
                    ...
                    <Col sm={9}><Input type="text"  placeholder="Enter Customer ID here" name="cust_id" id="cust_id" onChange={(e) => { setCustomers({ ...customers, cust_id: e.target.value }) }} /></Col>
                </FormGroup >
                <FormGroup row>
...
export default AdminCustUpdate;